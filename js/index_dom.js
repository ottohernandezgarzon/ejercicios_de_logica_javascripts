...
import networkStatus from "./decteccion_red.js"
import webCam from "./deteccion_webcam.js";
import getGeolocalizaction from "./geolocalizacion.js";
import searchFilter from "./filtro_busquedas.js";
import draw from "./sorteo.js";
import slider from "./carrusul.js";
...
d.addEventListener("DOMContentLoaded", (e) => {
	...
	responsiveMedia(
		...
		`<iframe width="560" height="315" src="https://www.youtube.com/embed/9fwQY6JOHaY" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`,
	);
	responsiveMedia(
		"gmaps",
		"(min-width:1024px)",
	...
	webCam("webcam");
	getGeolocalizaction("geolocalization");
